...
/**
* ----------------------------------------------------------------------------------------------------
*  $Source: /WEB/pw4/htdocs/site/templates/tests/cms/cms-basic_visual.php,v $
*  $Id: cms-basic_visual.php,v 1.3.2.2 2014/05/11 16:02:25 horst Exp $
* ----------------------------------------------------------------------------------------------------
*/
    ...
    foreach($images as $image) {
        ...
        if($coreImageSizer) {
            ...
            $img = $image->width($width, $options);
            $hasUsedCMS = isset($GLOBALS['useCMS']) ? " class='failed bold'" : " class='success'";
